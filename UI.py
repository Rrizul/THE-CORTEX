...
<div class="stage-title-wrap">
  ...
  <div class="neural-wrap">
    <svg viewBox="0 0 420 270" width="420" height="270" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Glow haloes -->
      <circle cx="210" cy="80"  r="30" fill="rgba(91,143,249,0.12)"  filter="url(#gB)"/>
      <circle cx="110" cy="200" r="24" fill="rgba(249,123,139,0.12)" filter="url(#gP)"/>
      <circle cx="310" cy="200" r="24" fill="rgba(91,249,196,0.12)"  filter="url(#gT)"/>

      <!-- Pulse rings -->
      <circle cx="210" cy="80" r="24" stroke="rgba(91,143,249,0.4)" stroke-width="1" fill="none">
        <animate attributeName="r"       from="24" to="46" dur="2.5s" repeatCount="indefinite"/>
        <animate attributeName="opacity" from="0.6" to="0"  dur="2.5s" repeatCount="indefinite"/>
      </circle>
      <circle cx="110" cy="200" r="20" stroke="rgba(249,123,139,0.4)" stroke-width="1" fill="none">
        <animate attributeName="r"       from="20" to="38" dur="3s" begin="0.8s" repeatCount="indefinite"/>
        <animate attributeName="opacity" from="0.5" to="0"  dur="3s" begin="0.8s" repeatCount="indefinite"/>
      </circle>
      <circle cx="310" cy="200" r="20" stroke="rgba(91,249,196,0.4)" stroke-width="1" fill="none">
        <animate attributeName="r"       from="20" to="38" dur="2.8s" begin="1.4s" repeatCount="indefinite"/>
        <animate attributeName="opacity" from="0.5" to="0"  dur="2.8s" begin="1.4s" repeatCount="indefinite"/>
      </circle>

      <!-- Connector lines -->
      <path d="M210,80 L110,200" stroke="rgba(91,143,249,0.28)" stroke-width="1.5" stroke-dasharray="5 4">
        <animate attributeName="stroke-dashoffset" from="36" to="0" dur="2s" repeatCount="indefinite"/>
      </path>
      <path d="M210,80 L310,200" stroke="rgba(249,123,139,0.28)" stroke-width="1.5" stroke-dasharray="5 4">
        <animate attributeName="stroke-dashoffset" from="36" to="0" dur="2.4s" repeatCount="indefinite"/>
      </path>
      <path d="M110,200 L310,200" stroke="rgba(91,249,196,0.2)" stroke-width="1.5" stroke-dasharray="4 5">
        <animate attributeName="stroke-dashoffset" from="0" to="36" dur="3s" repeatCount="indefinite"/>
      </path>

      <!-- Node cores -->
      <circle cx="210" cy="80"  r="24" fill="#0D1828" stroke="rgba(91,143,249,0.7)"  stroke-width="1.5"/>
      <circle cx="110" cy="200" r="20" fill="#0D1828" stroke="rgba(249,123,139,0.7)" stroke-width="1.5"/>
      <circle cx="310" cy="200" r="20" fill="#0D1828" stroke="rgba(91,249,196,0.7)"  stroke-width="1.5"/>

      <!-- Node icons -->
      <text x="210" y="86"  text-anchor="middle" dominant-baseline="middle" font-size="18" style="font-family:sans-serif;">🏛️</text>
      <text x="110" y="206" text-anchor="middle" dominant-baseline="middle" font-size="16" style="font-family:sans-serif;">💗</text>
      <text x="310" y="206" text-anchor="middle" dominant-baseline="middle" font-size="16" style="font-family:sans-serif;">🛡️</text>

      <!-- Travelling dots -->
      <circle r="4" fill="#5B8FF9" filter="url(#gB)">
        <animateMotion dur="2.2s" repeatCount="indefinite" path="M210,80 L110,200"/>
      </circle>
      <circle r="4" fill="#F97B8B" filter="url(#gP)">
        <animateMotion dur="2.8s" repeatCount="indefinite" begin="0.5s" path="M210,80 L310,200"/>
      </circle>
      <circle r="3.5" fill="#5BF9C4" filter="url(#gT)">
        <animateMotion dur="3.2s" repeatCount="indefinite" begin="1s" path="M110,200 L310,200"/>
      </circle>

      <!-- Labels -->
      <text x="210" y="48" text-anchor="middle" fill="rgba(91,143,249,0.7)"
            font-size="9" font-family="JetBrains Mono,monospace" letter-spacing="2">ARCHITECT</text>
      <text x="66"  y="230" text-anchor="middle" fill="rgba(249,123,139,0.7)"
            font-size="9" font-family="JetBrains Mono,monospace" letter-spacing="2">SOUL</text>
      <text x="352" y="230" text-anchor="middle" fill="rgba(91,249,196,0.7)"
            font-size="9" font-family="JetBrains Mono,monospace" letter-spacing="2">FILTER</text>

      <!-- Centre spark -->
      <circle cx="210" cy="148" r="5" fill="#F9D45B" opacity="0.7">
